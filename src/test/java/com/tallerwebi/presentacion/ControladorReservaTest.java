...
public class ControladorReservaTest {
    ...
    public void deberiaConfirmarPagoYMostrarVistaExitosa() throws Exception {
        ...
        when(servicioReservaMock.confirmarPagoReserva(reservaId, viajeroId, paymentId)).thenReturn(reservaMock);

        // When
        ModelAndView mav = controladorReserva.devolverPagoExitoso(sessionMock, paymentId, reservaId, redirectAttributesMock);
        ...
        verify(servicioReservaMock, times(1)).confirmarPagoReserva(reservaId, viajeroId ,paymentId);
    }
    ...
    public void deberiaRedirigirAMisReservasSiConfirmacionDePagoFalla() throws Exception {
        ...
        when(servicioReservaMock.confirmarPagoReserva(reservaId, viajeroId,paymentId))
    ...
    public void deberiaListarMisViajesCorrectamente() throws UsuarioInexistente {
        ...
        r1.setViaje(viajeDisponible);
        Reserva r2 = new Reserva();
        r2.setViaje(viajeEnCurso);
        Reserva r3 = new Reserva();
        r3.setViaje(viajeFinalizado);
        Reserva r4 = new Reserva();
        r4.setViaje(viajeCompleto);
        Reserva r5 = new Reserva();
        r5.setViaje(viajeCancelado);
